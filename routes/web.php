...
Route::group(['middleware' => 'auth'], function() {	
	...
	Route::get('estadistica/edad/{tipo}/{rango}/{year}', 'GraficasEdadController@graficaEdades');

	Route::post('/estadisticaEmpresas', 'GraficaEmpreasasController@urlGraficasEmpresa')->name('post.empresas');
	Route::get('estadisticas/empresas/{tipo}/{year}', 'GraficaEmpreasasController@graficaEmpresas');
	...
	Route::get('estadisticas/etnia/{tipo}/{etnia}/{year}', 'GraficasEtniaController@graficaEtnia');
	...
	Route::post('/estadisticaUnidad', 'GraficasUnidadController@urlGraficasUnidad')->name('post.unidad');
	Route::get('estadisticas/unidad/{unidad}/{year}', 'GraficasUnidadController@graficaUnidad');

	Route::post('/estadisticaColonia', 'GraficasColoniaController@urlGraficasColonia')->name('post.colonia');
	Route::get('estadisticas/colonia/{colonia}/{year}', 'GraficasColoniaController@graficaColonia');

	Route::post('/estadisticaSexo', 'GraficasSexoController@urlGraficasSexo')->name('post.sexo');
	Route::get('estadisticas/sexo/{tipo}/{year}', 'GraficasSexoController@graficaSexo');
